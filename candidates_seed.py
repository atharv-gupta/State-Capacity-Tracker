...
Reads candidates_seed.json (the researched 2026 roster) and upserts one row per
...
Usage:
    python candidates_seed.py                 # upsert from candidates_seed.json
...
def main():
    ...
    ap.add_argument("--file", default="candidates_seed.json")

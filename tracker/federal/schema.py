...
from tracker.congress.schema import (  # noqa: F401  (re-exported on purpose)
    COMPETENCY_CHOICES,
    REVIEW_FIELDS,
...
from tracker.congress.schema import TOPIC_TAG_CHOICES as _CONGRESS_TAGS
...
# rubrics/federal-adaptation.md for the instrument test.
# ---------------------------------------------------------------------------
